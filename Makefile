...
LDFLAGS=-ldflags="-s -w -X 'github.com/liangboceo/soar/common.Version=$(VERSION_VERSION)' -X 'github.com/liangboceo/soar/common.Compile=$(VERSION_COMPILE)' -X 'github.com/liangboceo/soar/common.Branch=$(VERSION_BRANCH)' -X 'github.com/liangboceo/soar/common.GitDirty=$(VERSION_GIT_DIRTY)' -X 'github.com/liangboceo/soar/common.DevPath=$(VERSION_DEV_PATH)'"
...
heuristic: doc
	...
	go test github.com/liangboceo/soar/advisor -v -update -run TestListHeuristicRules
	go test github.com/liangboceo/soar/advisor -v -update -run TestMergeConflictHeuristicRules
