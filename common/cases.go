...
func init() {
	...
	TestSQLs = []string{
		...
		// https://github.com/liangboceo/soar/issues/47
		...
		// https://github.com/liangboceo/soar/issues/17
		"create table hello.t (id int unsigned);",

		// https://github.com/liangboceo/soar/issues/146
		"select * from tb where data >= '';",

		// https://github.com/liangboceo/soar/issues/163
